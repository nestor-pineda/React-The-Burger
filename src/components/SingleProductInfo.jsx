    ...
    <div className="single-product">
      ...
      <div className="single-product__center">
        <div className="single-product__col single-product__col--border">
          <img className="single-product__img" src={`/images/${apiData.image}`} alt="hero other page" />
        </div>
        <div className="single-product__col">
          <div className="single-product__info">
            <h3 className="single-product__title">{apiData.title}</h3>
            <h3 className="single-product__price">{apiData.price}€</h3>
